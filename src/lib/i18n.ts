...
const en: StringTable = {
  ...
  "settings.sessions_dir.title": "Claude Code path",
  ...
  "settings.codex_sessions_dir.title": "Codex path",
  "settings.codex_sessions_dir.description": "Where Codex CLI writes rollout-*.jsonl files. Honors $CODEX_HOME.",
  "settings.gemini_sessions_dir.title": "Gemini path",
  "settings.gemini_sessions_dir.description": "Where Gemini CLI writes session-*.jsonl files (one chats/ folder per project). Honors $GEMINI_CLI_HOME.",
  ...
  "settings.show_source.gemini_title": "Show Gemini sessions",
  ...
  "continue.error_no_gemini": "gemini not found in PATH",
...
const zh: StringTable = {
  ...
  "settings.sessions_dir.title": "Claude Code 路径",
  ...
  "settings.codex_sessions_dir.title": "Codex 路径",
  "settings.codex_sessions_dir.description": "Codex CLI 写入 rollout-*.jsonl 的位置，遵循 $CODEX_HOME。",
  "settings.gemini_sessions_dir.title": "Gemini 路径",
  "settings.gemini_sessions_dir.description": "Gemini CLI 写入 session-*.jsonl 的位置（每个项目一个 chats/ 子目录），遵循 $GEMINI_CLI_HOME。",
  ...
  "settings.show_source.gemini_title": "显示 Gemini 会话",
  ...
  "continue.error_no_gemini": "在 PATH 中未找到 gemini 命令",
